-- Create comprehensive course management schema (avoiding existing types)
...
-- Extend profiles table with additional fields (if they don't exist)
DO $$ 
BEGIN
...
-- Add update triggers for updated_at columns (only if they don't exist)
DO $$ 
BEGIN
