-- Add student_name field to certificates table to store the student's name
ALTER TABLE public.certificates 
ADD COLUMN IF NOT EXISTS student_name text;

-- Update the award_certificate function to include student name
CREATE OR REPLACE FUNCTION public.award_certificate(
  _user_id uuid, 
  _course_id uuid, 
  _enrollment_id uuid, 
  _completion_date timestamp with time zone, 
  _score integer DEFAULT NULL::integer, 
...
BEGIN
  ...
  -- Create certificate with student name
